...
<div
	class="flex h-full w-80 flex-col border-l border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900"
>
	<!-- Header -->
	<header
		...
		{:else}
			...
			<div class="space-y-3 p-4">
				...
				<div class="flex flex-col gap-2 pt-1">
					...
					<button
						onclick={() =>
							copyToClipboard(`${friend!.latitude}, ${friend!.longitude}`, 'Coordinates copied')}
						class="flex items-center gap-2 rounded-lg border border-gray-200 px-3 py-2 text-xs font-medium text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800"
					>
						<svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path
