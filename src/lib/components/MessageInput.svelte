<script lang="ts">
	...
	const canUseSchedule = $derived(
		!!onSendScheduled && !isDisabled && !pendingFile && !replyTo
	);
...
<div class="border-t border-gray-200 bg-white p-3">
	...
	<div class="flex items-end gap-2">
		...
		<div class="relative flex shrink-0 items-center">
			...
			{#if showSendMenu}
				<div class="absolute bottom-11 right-0 z-40 min-w-52 rounded-xl border border-gray-200 bg-white p-1 shadow-lg">
...
{#if showScheduleDialog}
	...
	>
		...
		<div class="mt-4 flex items-center justify-end gap-2">
			...
			<button
				type="button"
				onclick={() => { if (scheduleTimestamp) { submitScheduled(scheduleTimestamp); } }}
