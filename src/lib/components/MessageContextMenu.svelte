<script lang="ts">
  ...
  const isScheduledPending = $derived(
    message.schedule_type === 2 && !message.date_retracted && message.date > Date.now()
  );
        ...
        >
          <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M16.862 4.487a2.1 2.1 0 113 2.97L9 18.319 5 19l.682-4 11.18-10.513z"
            />
          </svg>
        ...
        >
          <svg class="h-5 w-5 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M6 7h12M9 7V5h6v2m-7 3v7m4-7v7m4-7v7M5 7h14l-1 12H6L5 7z"
            />
          </svg>
          {unsendLabel}
        </button>
